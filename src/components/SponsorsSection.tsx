...
const SponsorsSection = () => {
  const sponsors = [
    ...
    },
    {
      ...
      logo: "🚀",
      description: "Venture capital firm investing in early-stage startups and student entrepreneurs.",
      partnership: "2 years",
    ...
    },
    {
      ...
      logo: "🏦",
      description: "Providing financial services and startup loans to emerging entrepreneurs.",
      partnership: "4 years",
    ...
    },
    {
      ...
      logo: "☁️",
      description: "Cloud infrastructure and software development services for student projects.",
      partnership: "1 year",
    ...
    },
    {
      ...
      logo: "🌱",
      description: "Renewable energy company promoting sustainable business practices.",
      partnership: "2 years",
  ...
  const partnershipLevels = [
    {
      ...
      benefits: ["Logo on all materials", "Speaking opportunity", "Exhibition space"]
    },
    {
      title: "Gold Partner",
      color: "from-yellow-500 to-yellow-600",
      textColor: "text-yellow-400",
      benefits: ["Premium branding", "Workshop sessions", "Mentorship programs"]
    },
    {
      title: "Silver Partner",
      color: "from-slate-400 to-slate-500",
      textColor: "text-slate-400",
      benefits: ["Brand visibility", "Networking access", "Recruitment drives"]
    }
  ];
